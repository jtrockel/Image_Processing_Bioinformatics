...
class OptimizeParams:
    ...
    def optimizeSurf(self,params,n=100, test=False):
        print(params)
        st = time.time()
    ...
    def optimizeSift(self,params,n=100, test=False):
        print(params)
        st = time.time()
        self.currentParams = params
    ...
    def optimizeOrb(self,params,n=100, test=False):
        st = time.time()
        self.currentParams = params
        self.currentAlg = "ORB"
    ...
    def optimizeAFunction(self, func, bestGuess, bounds):
        st = time.time()
        res = dual_annealing(func, bounds, maxiter=100)
        print(res)
    ...
    def minimizeAll(self):
        ...
        res_orb = self.optimizeOrb(self.bestGuessOrb, -1, test=True)
        res_surf = self.optimizeSurf(self.bestGuessSurf,-1,test=True)
        res_sift = self.optimizeSift(self.bestGuessSift,-1,test=True)
